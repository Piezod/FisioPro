...
public class SvVerConsultas extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (request.getParameter("oper").equalsIgnoreCase("consultashoy"))
		{
			System.out.println("devuelvo lista consultas");
			   String json = new Gson().toJson(consultashoy());
			    response.setContentType("application/json");
			    response.setCharacterEncoding("UTF-8");
			    response.getWriter().write(json);
		}
		else if (request.getParameter("oper").equalsIgnoreCase("detalle"))
		{
